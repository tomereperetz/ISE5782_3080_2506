...
class SphereTests {
    ...
    public void testFindIntersections() {
        ...
        assertEquals(List.of(new Point(1, 0, 1)), result, "Ray starts inside sphere");
        ...
        result = sphere.findIntersections(new Ray(new Point(0, 0, 1),
                new Vector(0, 0, -2)));
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(List.of(new Point(0, 0, 1)), result, 
        		"Ray starts at sphere and get inside");
        
        // TC15: Ray starts inside (1 points)
        result = sphere.findIntersections(new Ray(new Point(0, 0, 0.5),
                new Vector(0, 0, 2)));
        assertEquals(1, result.size(), "Wrong number of points");
        assertEquals(List.of(new Point(0, 0, 1)), result, 
        		"Ray starts at sphere and get inside");
